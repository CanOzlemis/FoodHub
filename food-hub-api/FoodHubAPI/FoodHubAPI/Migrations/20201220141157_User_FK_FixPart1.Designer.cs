...
namespace FoodHubAPI.Migrations
{
    ...
    [Migration("20201220141157_User_FK_FixPart1")]
    partial class User_FK_FixPart1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodHubAPI.Models.User", b =>
                {
                    ...
                    b.Property<int?>("RestaurantIdId")
                        .HasColumnType("int");

                    b.Property<DateTime>("Updated")
                        .HasColumnType("datetime2");

                    b.HasIndex("RestaurantIdId");
            ...
            modelBuilder.Entity("FoodHubAPI.Models.User", b =>
                {
                    b.HasOne("FoodHubAPI.Models.RestaurantDetail", "RestaurantId")
                        .WithMany()
                        .HasForeignKey("RestaurantIdId");
